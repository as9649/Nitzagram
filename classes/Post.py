...
class Post:
    ...
    def display_header(self):
        ...
        display_to_location = location_font.render(self.location, True, (134, 134, 134))
    ...
    def display_likes(self):
        ...
        display_to_likes = likes_font.render(f"Liked by {self.likes_counter} users", True, BLACK)
